...
[![Maven](https://badges.mvnrepository.com/badge/io.github.hakky54/logcaptor/badge.svg?label=Maven)](https://mvnrepository.com/artifact/io.github.hakky54/logcaptor)
[![Maven](https://badges.mvnrepository.com/badge/io.github.hakky54/logcaptor/badge.svg?type=rank&label=Maven)](https://mvnrepository.com/artifact/io.github.hakky54/logcaptor)
...
```
libraryDependencies += "io.github.hakky54" % "logcaptor" % "2.12.7" % Test
```
### Install with Apache Ivy
```xml
<dependency org="io.github.hakky54" name="logcaptor" rev="2.12.7" />
```
