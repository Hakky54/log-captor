...
### Install with Gradle
```groovy
testImplementation 'io.github.hakky54:logcaptor:2.7.6'
```
### Install with Scala SBT
```
libraryDependencies += "io.github.hakky54" % "logcaptor" % "2.7.6" % Test
```
### Install with Apache Ivy
```xml
<dependency org="io.github.hakky54" name="logcaptor" rev="2.7.6" />
```
